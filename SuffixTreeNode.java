public abstract class SuffixTreeNode {
    ...
    /**
     * Shifts all elements one cell to the right,
     * until the "until" index, including.
     ...
     * Note: To compare two siblings in this tree, you need to compare only their first character, 
     * as they are surely different
     ...
     * Since this method is called before the compression method, we can
     * assume all nodes contain only one character each
